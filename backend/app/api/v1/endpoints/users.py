...
@router.get("/{id}/notes")
async def get_user_public_notes(id: UUID, note_service: NoteServiceDep) -> list[NoteResponse]:
...
async def update_user(
    id: UUID, data: UserUpdate, service: UserServiceDep, current_user: CurrentUserDep
) -> UserPublic:
    try:
...
async def delete_user(
    id: UUID, service: UserServiceDep, current_user: CurrentUserDep
) -> UserPublic:
    try:
